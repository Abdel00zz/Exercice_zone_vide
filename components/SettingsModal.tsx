		...
		>
			...
			>
				<header className="flex justify-between items-center p-6 border-b border-gray-200">
					<h2 className="text-2xl font-bold font-display text-slate-800">Paramètres de la fiche</h2>
					<button onClick={onClose} className="p-2 rounded-full hover:bg-gray-100 transition" aria-label="Fermer la fenêtre de paramètres">
			...
			<main className="p-6 overflow-y-auto text-gray-900">
				...
				<footer className="flex justify-end items-center gap-3 p-6 border-t border-gray-200 bg-gray-50 rounded-b-xl">
					<button onClick={onClose} className="px-6 py-2 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 font-semibold transition">
						Annuler
					</button>
					<button onClick={handleSave} className="px-6 py-2 text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 font-semibold transition">
						Enregistrer
					</button>
				</footer>
			</div>
